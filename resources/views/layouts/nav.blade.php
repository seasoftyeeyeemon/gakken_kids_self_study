  ...
  <body>
    <nav class="kids_challenge_navbar navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand" href="#">
        <img src="../img/kidsmeal_logo.png" width="100%" alt="logo">
      </a>
    ...
    <footer class="kids_challenge_footer">
      ...
      <div class="footer_play_container">
        <a class="d-flex flex-row align-items-center text-decoration-none text-dark go_to_premium_site" href="https://www.premiummeal.jp/">
